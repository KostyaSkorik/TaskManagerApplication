...
```
## Структура проекта
В своем проекте я использовал патерн проектирования\
MVC(Model View Controller) с разными слоями
<img src="mdPages/MVC_Model.png">
...
## Использование
1. Настроить Tomcat
2. Создать свою бд и создать в ней необходимые таблицы
3. Запустить свою БД на порту 5432
4. Открыть браузер по ссылке http://localhost:8080/TaskManager/registration
5. Зарегистрируйте нового пользователя
6. Создавайте задачи, устанавливайте приоритеты и сроки выполнения
7. Отслеживайте прогресс выполнения задач
